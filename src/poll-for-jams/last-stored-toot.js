...
function getLastTootStored(tableName, docClient, lastTootId) {
    return __awaiter(this, void 0, void 0, function () {
        var params, results, sinceId;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (latest) {
                ...
                return [2 /*return*/, docClient.put(params).promise()];
            }
            return [2 /*return*/];
        });
    });
